...
function checkPrevious() {
    ...
    if(prev == null || paramChecker.get('Previous').localeCompare((0x53746131 ^ 0xDEADBEEF) * -1) != 0) {
...
function checkSolution(){
    ...
    if(document.getElementById("numberOfSnakes").value == 4) {
        ...
        document.getElementById("button1").onclick = function() {
            ...
            */
            location.href = "Station3.html?Previous=" + ((0x53746132 ^ 0xDEADBEEF) * -1);
