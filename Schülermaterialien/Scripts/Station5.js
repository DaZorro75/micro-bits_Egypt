...
function checkPrevious() {
    ...
    if(prev == null || paramChecker.get('Previous').localeCompare((0x53746134 ^ 0xDEADBEEF) * -1) != 0) {
...
function checkSolution(){
    ...
    if(document.getElementById("numberOfSteps").value == 12) {
        ...
        document.getElementById("button1").onclick = function() {
            ...
            */
            location.href = "Station6.html?Previous=" + ((0x53746135 ^ 0xDEADBEEF) * -1);
